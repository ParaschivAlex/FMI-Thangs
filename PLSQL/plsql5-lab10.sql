...
BEGIN
   ...
   pachet2_prof.p_emp('f','l','e',v_job_id=>'j',v_manager_id=>200,v_department_id=>50);
END;
/
...
BEGIN
  ...
  LOOP
    ...
    EXIT WHEN c_emp%NOTFOUND OR gasit;
...
EXECUTE pachet4_prof.p_verific(200,'AD_ASST');
